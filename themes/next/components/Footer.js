  ...
  return (
        ...
        >
            ...
            <span>
                ...
                <br />
                <h1>{title}</h1>
                <span className='text-xs font-serif  text-gray-500 dark:text-gray-300 '>Powered by  <a href='https://github.com/star-chow/NotionNext' className='underline '>star-chow {siteConfig('VERSION')}</a>.</span>
            </span>
        </footer>
  )
}
